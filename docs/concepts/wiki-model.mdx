...
<CardGroup cols={2}>
  ...
  <Card title="r2r-index-*.json" icon="server">
    The optional R2R reconciliation manifest. Carries document IDs and SHA-256 freshness hashes, but no page text or vectors. The endpoint, namespace, project, and optional collection select the filename. See [Semantic Backends](/configuration/semantic-backends).
  </Card>
